...
if radio_opt.index(selected_opt)==1:
    ...
    mysql_db = st.sidebar.text_input("MySQL Databse name")
else:
    db_uri = LOCALDB
...
@st.cache_resource(ttl="2")    ## It will take the user userid pass in chache for 2 hour so user dont need to login again
